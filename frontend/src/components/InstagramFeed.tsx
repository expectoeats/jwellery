...
const posts = [
  ...
  { img: "https://images.unsplash.com/photo-1602173574767-37ac01994b2a?w=400&h=400&fit=crop" },
  { img: "https://images.unsplash.com/photo-1617038260897-41a1f14a8ca0?w=400&h=400&fit=crop" },
];
  ...
  return (
    <section className="py-10 sm:py-14 md:py-18 bg-white">
      <div className="max-w-[1440px] mx-auto px-5 md:px-8 lg:px-12">
        ...
        <h2 className="text-center text-[24px] sm:text-[28px] md:text-[34px] lg:text-[38px] font-serif font-light text-[#2c2420] mb-2 sm:mb-3">
          @auragems
        </h2>
        <p className="text-center text-[11px] sm:text-[12px] font-sans text-[#6b5e54] mb-7 sm:mb-10">
          ...
          {posts.map((post, i) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-black/0 group-hover:bg-black/30 transition-colors duration-300 flex items-center justify-center">
                <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300" fill="currentColor" viewBox="0 0 24 24">
